...
class Application(tk.Frame):
    ...
    def finish_simulation(self):
        ...
        self.insight_label.config(text=insight_text, font=(FONT_FAMILY, 12, "bold"), foreground="#ffcc00")
    ...
    def update_live_data(self):
        ...
        for i, server in enumerate(self.simulation.servers):
            ...
            color = "#e74c3c" if state == "Busy" else "#2ecc71"
    ...
    def update_server_display(self, num_servers):
        ...
        for i in range(num_servers):
            label = ttk.Label(self.server_status_frame, text=f"S{i+1}: Free",
                              font=(FONT_FAMILY, 12, "bold"), foreground="#2ecc71")
            label.grid(row=i // cols, column=i % cols, padx=6, pady=4)
